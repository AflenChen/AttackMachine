...
"""
AMOUNT_PERCENT = (15, 20)  # Применяется для обменов.
AMOUNT_PERCENT_WRAPS = (10, 20)  # Применяется для модуля wrap_abuser.
LIQUIDITY_AMOUNT = ("70", "80")  # Применяется для добавления ликвидности, депозитов на лендинги и wrap ETH
TRANSFER_AMOUNT = (0.0001, 0.0002)  # Применяется для трансферов эфира на свой или рандомный адрес
MIN_BALANCE = 0.01  # Количество ETH на аккаунте
...
SLEEP_TIME_MODULES = (120, 300)    # (минимум, максимум) секунд | Время сна между модулями.
SLEEP_TIME_ACCOUNTS = (120, 300)   # (минимум, максимум) секунд | Время сна между аккаунтами.
...
'------------------------------------------------RETRY CONTROL---------------------------------------------------------'
MAXIMUM_RETRY = 6              # Количество повторений при ошибках
...
'-----------------------------------------------SLIPPAGE CONTROL-------------------------------------------------------'
SLIPPAGE = 0.75                    # 0.54321 = 0.54321%, 1 = 1% | Максимальное влияние на цену при обменах токенов

'-----------------------------------------------APPROVE CONTROL--------------------------------------------------------'
UNLIMITED_APPROVE = False       # Включает безлимитный Approve для контракта

'------------------------------------------------HELP SOFTWARE---------------------------------------------------------'
HELP_SOFTWARE = False  # Включает перевод автору 1% от суммы свапа при работе с агрегаторами. Перевод идет от контракта.
